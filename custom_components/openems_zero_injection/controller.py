        ...
        *,
        ...
        return {
            ...
            "battery": {
                ...
                "grid_input_power_w": battery.grid_input_power_w if battery else None,
                ...
                "source_entities": battery.source_entities if battery else {},
                "source_timestamps": battery.source_timestamps if battery else {},
                "source_ages_seconds": battery.source_ages_seconds if battery else {},
                "source_max_age_seconds": battery.source_max_age_seconds if battery else {},
